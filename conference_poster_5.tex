    ...
    \begin{enumerate}
        ...
        \adjustbox{valign=t}{%
            \begin{tcolorbox}[
                    ...
                    fonttitle = \bfseries,
                    breakable = true
                ]We construct a natural ``restriction'' morphism $\res \colon B \to \Auteq{D^b(F)}$ for each fiber $F$, which is nontrivial if $F$ is reducible.
            \end{tcolorbox}
        }
